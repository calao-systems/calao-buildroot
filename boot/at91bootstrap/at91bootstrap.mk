...
$(AT91BOOTSTRAP_DIR)/.unpacked: $(DL_DIR)/$(AT91BOOTSTRAP_SOURCE)
	mkdir -p $(BUILD_DIR) 
#	rm boot/at91bootstrap/*.patch
	$(AT91BOOTSTRAP_ZCAT) $(DL_DIR)/$(AT91BOOTSTRAP_SOURCE) | tar -C $(BUILD_DIR) $(TAR_OPTIONS) -
	cp $(BR2_BOARD_PATH)/at91bootstrap*.patch $(AT91BOOTSTRAP_DIR)
	toolchain/patch-kernel.sh $(AT91BOOTSTRAP_DIR) $(AT91BOOTSTRAP_DIR) at91bootstrap-$(AT91BOOTSTRAP_VERSION)\*.patch
